...
public class IncluirCentro extends Console implements Comando {
	
	private String id;
	private CentroDao dao = new CentroDao();
	private List<Menu> menus = new ArrayList<>();
	public IncluirCentro(String id) {
		this.id = id;
	...
	public Tela executar() {
		...
		Tela tela = new Tela("");
		print("Informe o NOME da Centro");
		Scanner scanner = new Scanner(System.in);
		String dado = scanner.nextLine();
		Centro centro = build(dado);
		String id = dao.inserir(centro);
		tela.escrever("-----");
		tela.escrever("Centro incluída com SUCESSO!");
		tela.escrever("-----");
